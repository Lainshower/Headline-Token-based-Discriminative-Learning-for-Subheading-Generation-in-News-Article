...
class ArgsBase():
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument('--data_type',
                            type=str,
                            default=f'yonhapnews', # Dataset Name
                            help='data type')
        
        parser.add_argument('--train_file',
                            type=str,
                            default='train.csv', # train file path
                            help='train file')

        parser.add_argument('--test_file',
                            type=str,
                            default='test.csv', # test file path
                            help='test file')
        ...
        parser.add_argument('--discriminator_path',
                            type=str,
                            default='monologg/koelectra-base-discriminator', # google/electra-base-discriminator 
...
class Subheading_DataModule(pl.LightningDataModule):
    def __init__(self, args):
        ...
        self.body_max_len = args.text_max_len
...
if __name__ == '__main__':
    ...
    model = Subheading_Generation(args)
    ...
    # Trainer
    trainer =  pl.Trainer.from_argparse_args(args, logger=[tb_logger,wandb_logger], accelerator='dp', callbacks=[checkpoint_callback, earlystop_callback, lr_logger])
